...
export const EditUniversity = () => {
  ...
  const { university, isLoading } = useGetUniversityById(universityid)

  // Initialize form data with the existing blog data
    {/* //dev by sanket Arjun pujari - sanketpujari33@gmiail.com - 7378768735 */} 
  const { register, isUniversityLoadings, isFormData, handleSubmit, setValue, setFormData, Controller, control, reset, trigger, errors, error } = useUpdateUniversity({ university, universityid }); // Using the custom hook
  {/* //dev by sanket Arjun pujari - sanketpujari33@gmiail.com - 7378768735 */} 
      ...
      {isFormData.media.images.map((image, index) => (
        <div key={index} className="space-y-4 border p-4 rounded-lg bg-white shadow-md">
          <div>
            ...
            {(image.file instanceof File || image.url) && (
              <div className="mt-2">
                <img
  ...
  {/* //dev by sanket Arjun pujari - sanketpujari33@gmiail.com - 7378768735 */} 
      ...
      {isLoading || isUniversityLoadings && (
